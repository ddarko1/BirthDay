...
public class MagentaPoint extends AbstractPoint implements PointSS, PointConstants {
	...
	public MagentaPoint(int x, int y) {
		//Calls method from the super class
		super(x,y);
	}
	
	public Color getColor() {
		//returns a magenta color from color class
